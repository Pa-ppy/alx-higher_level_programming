#!/usr/bin/python3
"""
This module defines a Rectangle class that includes methods for computing area, perimeter, displaying the rectangle, recreating the object, and displaying
a message upon deletion.
"""
