#!/usr/bin/python3
"""
This module defines a Rectangle class that includes methods for computing area, perimeter, displaying the rectangle with a specific symbol, recreating the object, handling instance counting, deleting with a message, comparing rectangle sizes, and creating a square.
"""
...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Parameters:
            rect_1 (Rectangl)e: The first rectangle.
    ...
    def square(cls, size=0):
        ...
        Parameters:
            size (int): The size of both the width and the height of the square.

        Returns:
            Rectangle: A new Rectangle instance with both width and height set to size.
        """
