#!/usr/bin/python3
"""
This module defines a Student class with attributes and methods to retrieve
and reload a dictionary representation of the Student instance.
"""
...
class Student:
    ...
    def reload_from_json(self, json):
        ...
        Args:
            json (dict): The dictionary containing attribute values to replace.
        """
